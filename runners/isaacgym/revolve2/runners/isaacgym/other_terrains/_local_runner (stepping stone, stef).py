...
class LocalRunner(Runner):
    class _Simulator:
        ...
        def _create_envs(self) -> List[GymEnv]:
            ...
            def new_sub_terrain(): return SubTerrain(width=1, length=1, vertical_scale=vertical_scale, horizontal_scale=horizontal_scale)
            
            
            heightfield = stepping_stones_terrain(SubTerrain(width=1024, length=1024, vertical_scale=vertical_scale, horizontal_scale=horizontal_scale), stone_size=2., stone_distance=2., max_height=0.5, platform_size=0.).height_field_raw    
