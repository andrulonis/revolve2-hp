...
class LocalRunner(Runner):
    class _Simulator:
        ...
        def _create_envs(self) -> List[GymEnv]:
            ...
            plane_params.static_friction = friction_var
            plane_params.dynamic_friction = friction_var
            ...
            for env_index, env_descr in enumerate(self._batch.environments):
                ...
                for actor_index, posed_actor in enumerate(env_descr.actors):
                    ...
                    props["friction"].fill(friction_var)
                    ...
                    for body, rigid_props in zip(
                        ...
                        rigid_props.friction = friction_var
                        rigid_props.rolling_friction = friction_var
