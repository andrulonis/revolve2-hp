...
from isaacgym.terrain_utils import SubTerrain, convert_heightfield_to_trimesh, pyramid_sloped_terrain

# rest of the code until line 92 with self._gym.add_ground(self._sim, // plane_params)
...
class LocalRunner(Runner):
    class _Simulator:
        ...
        def _create_envs(self) -> List[GymEnv]:
            ...
            heightfield = pyramid_sloped_terrain(SubTerrain(width=2000, length=2000, vertical_scale=vertical_scale, horizontal_scale=horizontal_scale), slope=0.10).height_field_raw
            ...
            tm_params.transform.p.x = -45.50
            tm_params.transform.p.y = -45.50
